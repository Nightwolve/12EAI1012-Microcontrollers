...
int main(void)
{
    ...
    //CyBle_Start( Stack_Handler );
    //:CyBle_IasRegisterAttrCallback( Ias_Handler );
    //BLE_Update(); //Moet gebruikt worden, maar is een for(;;) loop
...
void Ias_Handler ( uint32 eventCode, void *eventParam, int mode )
{
